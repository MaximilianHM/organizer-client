    ...
    <body className="flex items-center justify-center w-screen h-screen p-10 space-x-6 bg-gray-300">
      ...
      <div className="flex flex-col items-center w-16 h-full overflow-hidden text-gray-700 bg-gray-100 rounded">
        ...
        <div className="flex flex-col items-center mt-3 border-t border-gray-300">
          <a className="flex items-center justify-center w-12 h-12 mt-2 rounded hover:bg-gray-300">
            <svg
              className="w-6 h-6 stroke-current"
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
          ...
          <a className="flex items-center justify-center w-12 h-12 mt-2 bg-gray-300 rounded">
            <svg
              className="w-6 h-6 stroke-current"
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
        ...
        <a className="flex items-center justify-center w-16 h-16 mt-auto bg-gray-200 hover:bg-gray-300">
          <svg
            className="w-6 h-6 stroke-current"
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
      ...
      <div className="flex flex-col items-center w-40 h-full overflow-hidden text-gray-700 bg-gray-100 rounded">
        ...
        <div className="w-full px-2">
          ...
          <div className="flex flex-col items-center w-full mt-2 border-t border-gray-300">
            ...
            <a className="relative flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-300">
              <svg
                className="w-6 h-6 stroke-current"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
      ...
      <div className="flex flex-col items-center w-16 h-full overflow-hidden text-indigo-300 bg-indigo-900 rounded">
        ...
        <div className="flex flex-col items-center mt-3 border-t border-gray-700">
          <a className="flex items-center justify-center w-12 h-12 mt-2 rounded hover:bg-indigo-700">
            <svg
              className="w-6 h-6 stroke-current"
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
      ...
      <div className="flex flex-col items-center w-40 h-full overflow-hidden text-indigo-300 bg-indigo-900 rounded">
        ...
        <div className="w-full px-2">
          <div className="flex flex-col items-center w-full mt-3 border-t border-gray-700">
            <a className="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-indigo-700">
              <svg
                className="w-6 h-6 stroke-current"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
